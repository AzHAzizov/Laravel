...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <a href="{{route('admin.index')}}" class="btn btn-info d-inline-block mr-2">Список состояние </a>
                        <div class="dropdown show">
                          ...
                          <div class="dropdown show d-inline-block ml-2">
                            <a class="btn btn-primary dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Управление пользовалелями
                            </a>

                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">

                              <a class="dropdown-item" href="{{route('admin.user_managment.user.index')}}">Список пользователей</a>
                            </div>
                          </div>
                    </ul>
    ...
    <script src="https://kit.fontawesome.com/292b0af901.js" crossorigin="anonymous"></script>
